...
final class PhoneTest extends TestCase
{
    ...
    public function testConstructorWithoutPhoneNumberUtilLoaded(): void
    {
        ...
        $this->expectExceptionMessage('The "Fxp\Component\SmsSender\Mime\Phone" class cannot be used as it needs "InvalidClass"; try running "composer require giggsey/libphonenumber-for-php".');
    ...
    public function testCreateWithInvalidType(): void
    {
        ...
        $this->expectExceptionMessage('A phone can be an instance of Fxp\Component\SmsSender\Mime\Phone or a string ("stdClass" given).');
